port module Job exposing (Flags, Model, Msg(..), changeToJob, init, subscriptions, update, updateWithMessage, view)
...
import Html.Attributes exposing (attribute, class, disabled, href, id)
